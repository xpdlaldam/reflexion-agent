...
res = graph.invoke(
    {
        "messages": [
            {
                "role": "user",
                "content": "Give me advice on how to collect Pokemon cards TCG that will hopefully increase in value over time. I am interested in collecting team rocket set from 2000. Do you think this will go up in value over time?",
            }
        ]
    }
)
